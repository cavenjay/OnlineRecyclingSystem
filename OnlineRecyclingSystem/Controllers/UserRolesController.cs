...
namespace OnlineRecyclingSystem.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(UserManager<OnlineRecyclingSystemUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            foreach (OnlineRecyclingSystemUser user in users)
            {
                var thisViewModel = new UserRolesViewModel();
                thisViewModel.UserId = user.Id;
                thisViewModel.Email = user.Email;
                thisViewModel.FullName = user.User_Name;
        ...
        private async Task<List<string>> GetUserRoles(OnlineRecyclingSystemUser user)
        {
